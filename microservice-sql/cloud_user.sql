...
-- Records of app_user
-- ----------------------------
INSERT INTO `app_user` VALUES ('1', 'admin', '$2a$10$joqQB496avjndU.OkeoRx.YArHh0Xhmp9DTvddP.NVn3wjIvhdbge', 'admin', 'http://mugglelee.nat300.top/api-f/statics/2019/11/02/88655cb64e3398fbd82ac4623cbffced.jpg', '18320628585', '1', '1', 'BACKEND', '2018-01-17 16:57:01', '2019-11-02 19:27:34');
INSERT INTO `app_user` VALUES ('2', 'superadmin', '$2a$10$8ETcPqld2uKNXCBBeCRAcOHPZIzRwAkm6mQ3iK556rBN.M0xkJhM2', '超级管理员', null, null, '1', '1', 'BACKEND', '2018-01-19 20:30:11', '2018-01-19 20:30:11');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', 'SUPER_ADMIN', '超级管理员', '2018-01-19 20:32:16', '2019-08-25 00:27:26');
INSERT INTO `sys_role` VALUES ('2', 'TOURIST', '游客', '2019-11-02 00:21:20', '2019-11-02 19:04:07');
...
CREATE TABLE `t_wechat` (
  ...
  KEY `userId` (`userId`),
  KEY `unionid` (`unionid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='微信信息表';

-- ----------------------------
-- Records of t_wechat
-- ----------------------------
INSERT INTO `t_wechat` VALUES ('1', 'oMVDVstmfY7p2wqqLCRgXxRS9vpQ', null, '1', 'app1', 'muggle', '1', '广东', '广州', '中国', 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTIFvJMPUevfvEiacglgkQ73hCO38J684dmBQprNDvZLLZvL566icLarcoPGvvCpCPU3a7KzLtx0R6bQ/132', '2019-09-03 14:35:40', '2019-11-02 19:47:17');
...
-- ----------------------------
INSERT INTO `user_credentials` VALUES ('18320628585', 'PHONE', '1');
INSERT INTO `user_credentials` VALUES ('admin', 'USERNAME', '1');
INSERT INTO `user_credentials` VALUES ('oMVDVstmfY7p2wqqLCRgXxRS9vpQ', 'WECHAT_OPENID', '1');
INSERT INTO `user_credentials` VALUES ('superadmin', 'USERNAME', '2');
INSERT INTO `user_credentials` VALUES ('Tourist', 'USERNAME', '15');
